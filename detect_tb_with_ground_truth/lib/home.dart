...
class _MyHomeState extends State<MyHome> {
  ...
  Future<void> uploadAudio(File audioFile) async {
    final url =
        "http://13.232.214.14/predict"; // Change this to your Flask back-end URL
    ...
    setState(() {
      ...
      if (prediction.length >= 2) {
        ...
        groundtruth = prediction[2];
      }
    });
    print(responseData);
    print(predicted); print(groundtruth);
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                ...
                : Text(''),
            groundtruth != '' ? Text("GROUND TRUTH : $groundtruth", style: TextStyle(fontSize: 15),) : Text(""),
          ],
        ),
      ),
    );
